...
<script setup>
  ...
  const chartOptions = { responsive: true, cutout: '80%', plugins: { legend: { display: false } } };
...
<style scoped>
  ...
  .card-eur { background: linear-gradient(135deg, #78350F, #451a03); }
  .card-btc { background: linear-gradient(135deg, #111827, #000000); }
