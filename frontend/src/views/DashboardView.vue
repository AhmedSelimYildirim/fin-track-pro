...
<style scoped>
  ...
  .icon-btn { background: #1e293b; color: white; border: 1px solid #334155; width: 55px; height: 55px; border-radius: 12px; cursor: pointer; font-size: 1.5rem; display: flex; align-items: center; justify-content: center; transition: 0.3s; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }
