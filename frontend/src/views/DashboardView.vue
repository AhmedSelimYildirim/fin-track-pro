...
<style scoped>
  ...
  .c-item { padding: 12px 15px; cursor: pointer; color: var(--text-color); transition: 0.2s; border-bottom: 1px solid rgba(255,255,255,0.05); display: flex; align-items: center; gap: 10px; }
  .c-item:hover { background: var(--hover-bg); color: #FFD700; padding-left: 20px; }
